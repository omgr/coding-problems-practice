 ...
 *     
 *     1. What data structure will you use in JavaScript?
 *     2. Map vs Object - which one and why?
...
function twoSum(nums, target) {
    ...
    // Hint: Use a Map or Object to store numbers you've seen
...
function runTests() {
    ...
    console.log("Running Two Sum Tests - JavaScript");
    console.log("=".repeat(60));
...
module.exports = { twoSum, runTests };
